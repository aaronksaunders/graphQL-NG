...
## This project was generated with [Angular CLI](https://github.com/angular/angular-cli) version 1.2.2. It is a sample application integrating Angular2 with [GraphQL](http://graphql.org/) using the [Apollo Client](http://dev.apollodata.com/angular2/)
